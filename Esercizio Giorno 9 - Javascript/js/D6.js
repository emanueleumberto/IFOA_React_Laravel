...
//function myConcat2(str1, str2) {}
//const myConcat3 = (str1, str2) => {}
const myConcat = function (str1, str2) {
  // slice()
  //Soluzione 1
  /* let s1 = str1.slice(0, 2);
  let s2 = str2.slice(-3, str2.length)
  //let conc = s1 + s2;
...
const getPari = (myArr) => myArr.filter(ele => ele % 2 === 0)
console.log(getPari([2,5,8,6,3,7]))

/* ESERCIZIO 4 (forEach)
  Scrivi una funzione per sommare i numeri contenuti in un array
*/

const sommaNumeriEach = function (arr) {
  let somma = 0;
  arr.forEach(ele => somma += ele)
  return somma;
}

console.log(sommaNumeriEach(arrRand));
...
console.log(sommaNumeriReduce(arrRand));
...
console.log(searchFilm(movies, 'tt0077869'))
